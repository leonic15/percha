...
- **Cuando** el formulario carga
- **Entonces** se muestra el clima de la ciudad configurada manualmente (PERCHA-023); si no hay ciudad configurada, se muestra un mensaje invitando a configurarla con link directo a la configuración
...
- [PERCHA-017] Generar look desde cero (consume los datos de clima)
- [PERCHA-023] Configurar ciudad manualmente (fallback de geolocalización)
