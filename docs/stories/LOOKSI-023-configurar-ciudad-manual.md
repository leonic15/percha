...
- [LOOKSI-022] Obtener y mostrar clima en el generador de looks
- [LOOKSI-006] Preferencias y configuración del usuario — EP-06 (la configuración de ciudad vive en esa pantalla)
