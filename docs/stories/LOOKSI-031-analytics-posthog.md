...
Como **dueño del producto**, quiero **tener métricas de uso detalladas de LookSi en un dashboard de Posthog** para **entender cómo se usa la app, qué features se usan más y cuánto cuesta la IA, sin exponer esta información a los usuarios finales**.
...
- **Cuando** cualquier usuario de LookSi intenta acceder
...
- [LOOKSI-028] CI/CD con GitHub Actions y deploy en Vercel
