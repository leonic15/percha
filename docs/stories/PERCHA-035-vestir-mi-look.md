...
- [PERCHA-033] Datos corporales en perfil (requiere género, altura, peso)
- [PERCHA-034] Foto de cuerpo completo en perfil (requiere `body_photo_url`)
- [PERCHA-017] Generar look desde cero (pantalla de resultado donde aparece el botón)
- [PERCHA-020] Guardar look (para asociar la imagen al look guardado)
- [PERCHA-021] Historial de looks guardados (la imagen debe mostrarse en el detalle del look)
