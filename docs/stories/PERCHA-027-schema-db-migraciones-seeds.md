...
- **Entonces** la tabla `categories` tiene las 8 categorías y la tabla `subcategories` tiene todas las subcategorías asociadas definidas en PERCHA-009
...
- **Entonces** todas las tablas tienen RLS habilitado con políticas que garantizan que cada usuario solo puede acceder a sus propios datos (detalle en PERCHA-029)
...
- Seed en `/supabase/seed.sql` con las categorías y subcategorías de PERCHA-009
