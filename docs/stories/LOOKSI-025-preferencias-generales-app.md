...
- La pantalla de Configuración también aloja la sección de ciudad manual de clima (LOOKSI-023) y las preferencias de estilo (LOOKSI-024) en secciones separadas
...
- [LOOKSI-005] Edición de perfil básico (comparte tabla `profiles`)
- [LOOKSI-022] Obtener y mostrar clima en el generador de looks (toggle de clima)
- [LOOKSI-023] Configurar ciudad manualmente (vive en esta pantalla)
- [LOOKSI-024] Configurar preferencias de estilo personal (vive en esta pantalla)
