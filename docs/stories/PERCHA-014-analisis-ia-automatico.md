...
- [PERCHA-009] Agregar prenda (el análisis se dispara desde el formulario de agregar)
- [PERCHA-015] Revisión y aprobación de sugerencias de IA (siguiente paso del flujo)
