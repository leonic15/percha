...
- **Entonces** ve los mismos errores de validación que en el flujo manual (PERCHA-009 Escenario 6)

---

## Notas técnicas

- Los valores sugeridos por IA se pre-cargan en el mismo formulario de PERCHA-009 (no es una pantalla separada)
...
- [PERCHA-014] Análisis automático de prenda con IA al agregar
- [PERCHA-009] Agregar prenda (reutiliza el formulario)
