...
Como **usuario autenticado**, quiero **editar mi nombre y foto de perfil** para **personalizar mi cuenta en Percha**.
...
- [PERCHA-001] Registro con email y contraseña (estructura de tabla `profiles`)
- [PERCHA-003] Login con Google (pre-población de avatar desde Google)
