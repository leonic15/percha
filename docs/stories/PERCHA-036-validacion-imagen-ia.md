...
### Contexto A — Validación de imagen de prenda (PERCHA-009)
...
### Contexto B — Validación de foto corporal de perfil (PERCHA-034)
...
- [PERCHA-009] Agregar prenda — integración en Paso 1 del flujo
- [PERCHA-034] Foto de cuerpo completo en perfil — integración al seleccionar la foto
- [PERCHA-014] Análisis IA automático (comparte el patrón de prompt + API Route de Gemini)
- [PERCHA-035] Vestir mi look (se beneficia de la calidad de la foto corporal validada)
