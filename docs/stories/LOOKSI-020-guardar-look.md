...
- Si una prenda del look es eliminada posteriormente (LOOKSI-012), el registro en `look_prendas` queda con `prenda_id` marcado (via soft-delete o columna `prenda_eliminada: true`) para no romper el historial
