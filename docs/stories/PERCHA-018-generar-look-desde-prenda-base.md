...
- **Entonces** veo el look parcial con las prendas disponibles y la sección "Para completar este look te falta:" igual que en PERCHA-017

---

## Notas técnicas

- Reutiliza el mismo endpoint `POST /api/looks/generar` de PERCHA-017, con el campo adicional `prenda_base_id` en el payload
...
- [PERCHA-017] Generar look desde cero (comparte endpoint, formulario y flujo de resultado)
- [PERCHA-010] Ver detalle de prenda (punto de entrada alternativo)
