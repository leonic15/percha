...
- Reutilizar el mismo componente de formulario de PERCHA-009 en modo edición
...
- [PERCHA-009] Agregar prenda (reutiliza componente de formulario)
- [PERCHA-010] Ver detalle de prenda (punto de entrada a la edición)
