...
Como **usuario nuevo o existente**, quiero **iniciar sesión con mi cuenta de Google** para **acceder a Percha sin necesidad de recordar una contraseña**.
...
- **Dado** que soy un usuario nuevo sin cuenta en Percha
...
- **Dado** que ya tengo cuenta en Percha (ya sea por email/contraseña o Google previo)
...
- [PERCHA-001] Registro con email y contraseña (comparte trigger de creación de perfil)
- [PERCHA-002] Login con email y contraseña (comparte middleware de rutas protegidas)
