...
Como **usuario nuevo**, quiero **registrarme con mi email y una contraseña** para **crear mi cuenta en Percha y comenzar a gestionar mi guardarropas**.
...
- [PERCHA-007] Infraestructura base de Supabase y proyecto Next.js inicializado (EP-07)
